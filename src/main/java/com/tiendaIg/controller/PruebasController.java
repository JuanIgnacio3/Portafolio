package com.tiendaIg.controller;
...
import com.tiendaIg.service.ProductoService;
...
public class PruebasController {
    ...
    public String consultaPorExistencias(@RequestParam(value = "existenciasInf") int existenciasInf,
